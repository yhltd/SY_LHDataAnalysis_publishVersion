...
var showToastAuto = function(that) {
  ...
  wx.showToast({
    ...
    // image: 'https://7968-yhltd-lzok7-1258471393.tcb.qcloud.la/SY_LHDataAnalysis/btn.png?sign=455f4df0922c815857202c0bf7dbaa9a&t=1554721629',
    duration: 2000,
            ...
            .get({
              ...
              success(res) {
                ...
                wx.cloud.downloadFile({
                  fileID: 'cloud://yhltd-lzok7.7968-yhltd-lzok7/SY_LHDataAnalysis/txt/data.txt', // 文件 ID
                  success: res => {
